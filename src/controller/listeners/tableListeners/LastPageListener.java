...
public class LastPageListener implements ActionListener {
    ...
    public LastPageListener(JFrame frame, TableModel tableModel, StudentList studentList,UpdateWindow updateMainWindow)
    {
    ...
    {
       tableModel.lastPage(studentList.getStudentList().size());
